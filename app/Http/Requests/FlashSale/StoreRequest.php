...
class StoreRequest extends FormRequest
{
    ...
    {
        return [
            'start_time' => 'required|date_format:h:i A|before:end_time|unique:flash_sales,start_time',
            'end_time' => 'required|date_format:h:i A|after:start_time|unique:flash_sales,end_time',
