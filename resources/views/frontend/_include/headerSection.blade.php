                                ...
                                <li class="dropdown dropdown-mega-menu">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <a href="#"><img src="{{ asset('frontend') }}/assets/images/menu_banner4.jpg" alt="menu_banner4"></a>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <li class="dropdown dropdown-mega-menu">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <a href="#"><img src="{{ asset('frontend') }}/assets/images/menu_banner5.jpg" alt="menu_banner5"></a>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                                    ...
                                                    <div class="header_banner_content">
                                                        <div class="shop_banner">
                                                            <div class="banner_img overlay_bg_40">
                                                                <img src="{{ asset('frontend') }}/assets/images/shop_banner2.jpg" alt="shop_banner2"/>
                                                            </div>
