...
<!-- START HEADER -->
<div class="header_sticky_bar" style="height: 67px;"></div><header class="header_wrap fixed-top header_with_topbar nav-fixed" style="">
    	...
    	<div class="row align-items-center">
        	<div class="col-lg-6">
            	<div class="about_img scene mb-4 mb-lg-0">
                    <img src="{{ asset('frontend') }}/assets/images/about_img.jpg" alt="about_img">
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row justify-content-center">
        	<div class="col-lg-3 col-sm-6">
            	<div class="team_box team_style1">
                	<div class="team_img">
                    	<img src="{{ asset('frontend') }}/assets/images/team_img1.jpg" alt="team_img1">
            ...
            <div class="col-lg-3 col-sm-6">
            	<div class="team_box team_style1">
                	<div class="team_img">
                    	<img src="{{ asset('frontend') }}/assets/images/team_img2.jpg" alt="team_img2">
            ...
            <div class="col-lg-3 col-sm-6">
            	<div class="team_box team_style1">
                	<div class="team_img">
                    	<img src="{{ asset('frontend') }}/assets/images/team_img3.jpg" alt="team_img3">
                        <ul class="social_icons social_style4">
                            <li><a href="#"><i class="ion-social-facebook"></i></a></li>
                            <li><a href="#"><i class="ion-social-twitter"></i></a></li>
                            <li><a href="#"><i class="ion-social-googleplus"></i></a></li>
            ...
            <div class="col-lg-3 col-sm-6">
            	<div class="team_box team_style1">
                	<div class="team_img">
                    	<img src="{{ asset('frontend') }}/assets/images/team_img4.jpg" alt="team_img4">
                        <ul class="social_icons social_style4">
                            <li><a href="#"><i class="ion-social-facebook"></i></a></li>
                            <li><a href="#"><i class="ion-social-twitter"></i></a></li>
                            <li><a href="#"><i class="ion-social-googleplus"></i></a></li>
	...
	<div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                ...
                <div class="owl-stage-outer"><div class="owl-stage" style="transition: all 0.25s ease 0s; width: 5640px; transform: translate3d(-2820px, 0px, 0px);"><div class="owl-item cloned" style="width: 705px;"><div class="testimonial_box">
