        ...
        <div class="col-sm-9">
            <form action="{{ route('backend.site_config.quick.page.update',$page->id) }}" method="post" class="form-horizontal"
                ...
                <div class="form-group">
                   ...
                   {{--  <div class="col-sm-10">
                         <input id="x" type="hidden" name="short_desc" value="{{ $page->short_desc??'' }}">
                    ...
                    <div class="col-sm-10">
                        @include('backend.components.ck_editor',[
                                'name'  =>'short_desc',
                                'ckimage' =>'image',
                                'value' => $page->short_desc ?? old('short_desc')
                ...
                <div class="form-group">
                    <label class="col-sm-2 no-padding-right control-label no-padding-right" for="short_desc">Description </label>
                    <div class="col-sm-10">
                       <select class="form-control" id="form-field-select-1" name="section" required="">
                            @if($page->section ==  1)
                                <option value="1">First Section</option>
                            @elseif($page->section ==  2)
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-1">
                       <input type="checkbox" name='customer_care' {{ $page->customer_care == true? 'checked':' ' }}>
                         <div class="col-sm-9 col-sm-offset-2">
