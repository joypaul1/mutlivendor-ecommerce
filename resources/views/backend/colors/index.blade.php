...
@section('content')
    ...
    <form class="form-horizontal" method="post" action="{{ route('backend.product.colors.search') }}" role="form" enctype="multipart/form-data">
        ...
        <table class="table table-bordered">
            <tbody>
                <tr>
                    <th  class="bg-dark" style="width: 22%"><label for="name">Color Name.. </label></th>
                    <th class="bg-dark" style="width: 12%;">Actions</th>
                </tr>
                <tr>
                    <td>
                        <input type="text" id="myInput" name="search" placeholder="Color search here.." value="" class="input-sm form-control text-center" required>
                    </td>
                    <td>
                        <div class="btn-group btn-group-mini btn-corner">
                            ...
                            <a href="{{ route('backend.product.colors.index') }}" class="btn btn-xs btn-info" title="Show All">
