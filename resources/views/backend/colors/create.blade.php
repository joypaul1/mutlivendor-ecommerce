...
@section('content')
    ...
    <div class="col-sm-9">
        <form role="form"
              ...
              action="{{route('backend.product.colors.store')}}">
        @csrf
        ...
        <!-- Name -->
            ...
            {{-- value of color --}}
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="name">Color Value <sup class="red">*</sup></label>
                <div class="col-sm-4">
                    <div class="control-group">
						<div class="bootstrap-colorpicker">
							<input id="colorpicker1" type="text" class="input-small colorpicker-element" name="value">
						</div>
					</div>
