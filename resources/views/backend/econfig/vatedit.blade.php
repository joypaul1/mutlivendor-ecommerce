...
@section('content')
    ...
    <div class="col-sm-9">
        <form role="form"
              ...
              action="{{route('backend.econfig.vats.update', $subCategory->id)}}"
              >
        @csrf

        <!-- Name -->
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="name">Vat <sup class="red">*</sup></label>
