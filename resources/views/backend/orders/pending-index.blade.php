                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group btn-group-mini btn-corner">
                            @if(hasAccess('pending-order-show'))
                                <a href="{{route('backend.order.pending.show', $order->id)}}"
                                class="btn btn-xs btn-success"
                                title="Show">
                                    <i class="ace-icon fa fa-eye"></i>
                                </a>
                            @endif
                            @if(hasAccess('pending-order-edit'))
                                <a href="{{route('backend.order.pending.edit', $order->id)}}"
                                class="btn btn-xs btn-info"
                                title="Edit">
                                    <i class="ace-icon fa fa-pencil"></i>
                                </a>
                            @endif
                            @if(hasAccess('pending-order-delete'))
