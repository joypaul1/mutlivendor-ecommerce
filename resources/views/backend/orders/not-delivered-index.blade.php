...
@section('title', 'Not Delivered')
@section('page-header')
    <i class="fa fa-list"></i> Not Delivered
@stop
@push('css')
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group btn-group-mini btn-corner">
                            @if(hasAccess('order-not-delivery-show'))
                                <a href="{{route('backend.order.not-delivered.show', $order->id)}}"
                                class="btn btn-xs btn-success"
                                title="Show">
                                    <i class="ace-icon fa fa-eye"></i>
                                </a>
                            @endif
                            @if(hasAccess('order-not-delivery-edit'))
                                <a href="{{route('backend.order.not-delivered.edit', $order->id)}}"
                                class="btn btn-xs btn-info"
                                title="Edit">
                                    <i class="ace-icon fa fa-pencil"></i>
                                </a>
                            @endif
                            @if(hasAccess('order-not-delivery-delete'))
