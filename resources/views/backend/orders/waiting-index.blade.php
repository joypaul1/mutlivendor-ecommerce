                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group btn-group-mini btn-corner">
                            @if(hasAccess('waiting-order-show'))
                                <a href="{{route('backend.order.waiting.show', $order->id)}}"
                                class="btn btn-xs btn-success"
                                title="Show">
                                    <i class="ace-icon fa fa-eye"></i>
                                </a>
                            @endif
                            @if(hasAccess('waiting-order-edit'))
                                <a href="{{route('backend.order.waiting.edit', $order->id)}}"
                            ...
                            @if(hasAccess('waiting-order-edit'))
                                <button type="button" class="btn btn-xs btn-danger"
                                        onclick="delete_check({{$order->id}})" title="Delete">
