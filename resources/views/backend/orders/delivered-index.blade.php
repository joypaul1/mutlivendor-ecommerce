...
@section('content')
    ...
    <div class="table-responsive">
        <table class="table table-bordered">
            <tbody>
            <tr>
                <th class="bg-dark" style="width: 4%">SLss</th>
                ...
                <th class="bg-dark" style="width: 14%">Agent</th>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group btn-group-mini btn-corner">
                            @if(hasAccess('order-delivered-show'))
                                <a href="{{route('backend.order.delivered.show', $order->id)}}"
                                    class="btn btn-xs btn-success"
                                title="Show">
                                    <i class="ace-icon fa fa-eye"></i>
                                </a>
                            @endif
                            @if(hasAccess('order-delivered-delete'))
