...
@section('content')
    ...
    <div class="form-group text-right" style="height: 100px">
        ...
        <div class="col-md-6">
            ...
            <a class="btn btn-sm btn-danger" href="{{route('delivery.orders.delivery-error', $order->no)}}">
                <i class="fa fa-refresh"></i> Not Delivered
            </a>
            <a class="btn btn-sm btn-primary" href="{{route('delivery.orders.delivery-success', $order->no)}}">
                <i class="fa fa-check"></i> Delivered
            </a>

            <a class="btn btn-sm btn-gray" href="{{route('delivery.orders.on-delivery-index')}}">
